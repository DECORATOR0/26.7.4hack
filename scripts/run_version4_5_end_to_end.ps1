...
function Write-Status {
    ...
    [ordered]@{
        ...
        note = "Main verification rebuilds deterministic V4.5 report and web data from retained V4.5 artifacts."
...
Write-Status -Stage "version4_5_main_verify" -Status "started"
...
Write-Status -Stage "version4_5_main_verify" -Status "done"
Write-Output "[$((Get-Date).ToString("o"))] VERSION4.5 MAIN VERIFY DONE"
